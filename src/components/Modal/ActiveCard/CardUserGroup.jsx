...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Thông tin FE_allUsers từ redux của board hiện tại để đẩy vào card xử lý
  ...
  // Tạo một biến incomingMemberInfo để gửi cho BE, với 2 thông tin chính là userId và action là xóa khỏihay thêm vào card
